  ...
  Widget build(BuildContext context) {
    return Scaffold(
      bottomNavigationBar: Row(
        ...
        children: [
          Container(padding: const EdgeInsets.all(8.0) ,child: const Text("Today", textScaler: TextScaler.linear(1.5),)),
          Container(padding: const EdgeInsets.all(8.0) ,child: const Text("Exercises", textScaler: TextScaler.linear(1.5),)),
        ],
      ),
